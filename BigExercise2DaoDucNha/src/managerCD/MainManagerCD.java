...
public class MainManagerCD {
    ...
    public static void main(String[] args) throws IOException, SQLException, ClassNotFoundException, ParserConfigurationException, SAXException {
        ...
        while (flag == true) {
            System.out.println("==========================");
            System.out.println("1. Work with JDBC Java");
            System.out.println("2. Work with I/O File");
            System.out.println("3. Work with XML File");
            System.out.println("4. Exit");
            System.out.println("Please input your choise: ");
            int choise = Integer.parseInt(input.readLine());
            System.out.println("=========================");
            switch (choise) {
                //working with jdbc java
                case 1:
                    boolean flagJDBC = true;
                    while (flagJDBC == true) {
                        ...
                        int choiseJDBC = Integer.parseInt(input.readLine());
                        switch (choiseJDBC) {
                            //view list CD from 
                            case 1:
